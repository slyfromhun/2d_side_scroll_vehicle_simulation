...
func _process(_delta: float) -> void:
	effect.friction(speed_kph, frictionScenes, wheel_magnitude, wheelRB, slip_ratio_rear)
	effect.slip(speed_kph, slipScenes, wheel_magnitude, wheelRB, slip_ratio_rear)
	effect.grind(speed_kph, grindScenes, wheel_magnitude, wheelRB, slip_ratio_rear)
