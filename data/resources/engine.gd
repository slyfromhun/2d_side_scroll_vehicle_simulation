...
@export_range(400.0, 10000.0, 0.01, "suffix:RPM") var redline_rpm := 4900.0
...
@export_range(0.0, 1.0, 0.01, "suffix:x") var redline_power := 0.68
...
@export_range(100.0, 10000.0, 0.01, "suffix:RPM") var rpm_limit := 900.0
...
@export_range(400.0, 10000.0, 0.01, "suffix:RPM") var engine_brake_peak_rpm := 4900.0
@export_range(0.0, 1.0, 0.01, "suffix:J") var inertia := 0.3
## Target RPM when taking off from standstill
@export_range(400.0, 10000.0, 0.01, "suffix:RPM") var auto_clutch_rpm := 1300.0
